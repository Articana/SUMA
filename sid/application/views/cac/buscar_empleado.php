  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        ...
        <?php if($permiso == 3) $control = 'rec'; ?>
        <?php if($permiso == 5) $control = 'cac'; ?>
	<?php if($permiso == 9) $control = 'rh'; ?>
        <small><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>&nbsp;<a href="<?php if($docentes != FALSE){ echo base_url($control.'/vrdetalle/'.$docentes[0]->doc_id); }?>">Ver detalle</a></small>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        <?php if($docentes != FALSE){  ?>
            <p> <strong>Información del docente</strong>
            ...
            <?php } else{ ?> <em><?php echo 'Inactivo' ?></em><br> <?php }?> </p>
          <?php  } else { ?>
