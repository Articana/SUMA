  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <?php if($docente != FALSE){ foreach ($docente as $doce) { ?>
          <div class="row">
          <div class="col-md-4">
            <a href="#" class="thumbnail">
              <img style="height: 128px; width:128px;" src="<?php echo base_url('./upload/'.$docente[0]->doc_cvdir.'/'.$docente[0]->doc_fotografia); ?>" alt="..."></a>
          </div>
          <div class="col-md-4">
          <p><strong class="text-danger">Información del docente</strong>
            ...
            Fecha de ingreso: <em><?php echo $doce->doc_fechain; ?></em><br>
            Número de empleado: <em><?php echo $doce->doc_numemp; ?></em><br>
            Experiencia laboral: <em><?php echo $doce->doc_explab.' '. 'años'; ?></em><br>
	          Estatus: <?php if($doce->doc_estatus > 0){ ?> <em><?php echo 'Activo' ?>
          <?php } else{ ?><?php echo 'Inactivo' ?><?php }?>
          <small><a class="text-success" href="<?php echo base_url('cac/vudocente/'. $doce->doc_id.'/'.$letra); ?>"
         	title="Modificar"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;Modificar</a></small> </em><br>
          </p> <?php  }} else { ?>
          <p>No hay Información personal cargada para mostrar.</p>
          <?php } ?>
          </div>
        <?php if($contacto != FALSE) { foreach ($contacto as $con) { ?>
          <div class="col-md-4">
          <p><strong class="text-danger">Información de contacto</strong> <br>
    ...
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      ...
      Estatus: <?php if($f->docform_estatus > 0){?><em><?php echo 'Validado' ?></em><br>
        <?php } else{ ?> <em><?php echo 'No Validado' ?></em><br> <?php }?>
    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
      <div class="panel-body">
        ...
        Tipo de nombramiento: <em><?php echo $c->tiponomb_nombre; ?></em><br>
       <small>
	     <a class="text-danger" href="<?php echo base_url('cat/borrar/docente_categoria/' . $c->doccat_id.'/'.$doc_id.'/'.$letra); ?>" title="Eliminar">
    ...
    <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine">
      <div class="panel-body">
       ...
       <a class="text-danger" href="<?php echo base_url('cat/borrar/carga/').'/'; ?>{{o.car_id}}<?php echo '/'.$doc_id.'/'.$letra; ?>" title="Eliminar">
