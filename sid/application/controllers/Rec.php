...
class Rec extends CI_Controller {
	...
	public function filtro($letra = 'A')
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/rec_principal.php',array('docentes' => $this->Docente_model->select_where_paterno($letra)));
	...
	public function vrdetalle($doc_id = 0)
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/ver_detalle',$datos);
		$this->load->view('footer.php');
		//}
		} else 
		{
			redirect(base_url('rec'));
		}
		...
		public function vucontrasena()
		{
			...
			$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
			$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
			$this->load->view('/rec/cambiar_contrasena');
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_academia', $datos);
		$this->load->view('footer');
	}
	...
	public function vracademiamiembros()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));	
		$this->load->view('rec/listar_acamiembros', $data); 
		$this->load->view('footer.php'); 
	}
	...
	public function vrarea()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/listar_area', $data);
		$this->load->view('footer');
	}
	...
	public function vrinstitucion()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/listar_institucion', $data);
		$this->load->view('footer');
	}
	...
	public function vrcarrera()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/listar_carrera', $datos);
		$this->load->view('footer');
	}
	...
	public function vrcuerpoacademico()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_cuerpo_academico', $data);
		$this->load->view('footer.php'); 
	}
	...
	public function vrcuerpo_academico_miembros()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_miembros_ca', $datos);
		$this->load->view('footer');
	}
	...
	public function vrestado()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));	
		$this->load->view('rec/listar_estado', $data); 
		$this->load->view('footer.php'); 
	}
	...
	public function vrmunicipio()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));	
		$this->load->view('rec/listar_municipio', $data);
		$this->load->view('footer.php'); 
	}
	...
	public function vrnivel()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));	
		$this->load->view('rec/listar_nivel', $data);
		$this->load->view('footer.php'); 
	}
	...
	public function vrtipoformacion()
	{
		...
		$this->load->view('header.php', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));	
		$this->load->view('rec/listar_tipo_formacion', $data); 
		$this->load->view('footer.php'); 
	}
	...
	public function vrmodalidad()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_tipo_modalidad', $dato);
		$this->load->view('footer');
	}
	...
	public function vrtipo_nivel_habilitacion()
	{
		...
		$this->load->model('Nivel_habilitacion_model');
        	...
        	$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/listar_habilitacion', $data);
		$this->load->view('footer');
	}
	...
	public function vrtipo_nombramiento()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_tipo_nombramiento', $datos);
		$this->load->view('footer');
	}
	...
	public function vrtipoperiodo()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('rec/listar_periodo', $data);
		$this->load->view('footer');
	}
	...
	public function vrtipo_titulo()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_tipo_titulo', $datos);
		$this->load->view('footer');
	}
	...
	public function vrusuario()
	{
		...
		$this->load->view('header', array('title' => 'Sistema de Información Docente | Módulo REC'));
		$this->load->view('navbar_rec.php', array('current_user' => $this->session->userdata('username')));
		$this->load->view('/rec/listar_usuario', $data);
		$this->load->view('footer');
